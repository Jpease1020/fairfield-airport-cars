...
/**
 * Cursor Agents JSX Cleanup Script
 * 
 * This script provides comprehensive instructions for Cursor Agents to help with
 * systematic JSX refactoring in the Fairfield Airport Cars project.
 * 
 * Usage: Copy this script and the AI prompt to Cursor Agents for automated cleanup
 */

const CURSOR_AGENTS_INSTRUCTIONS = `# 🚀 Cursor Agents JSX Cleanup Instructions
...
// Export the instructions for easy copying
console.log('📋 Cursor Agents JSX Cleanup Instructions:');
console.log('==========================================');
console.log(CURSOR_AGENTS_INSTRUCTIONS);

// Also save to a file for easy access
const fs = require('fs');
const path = require('path');

const outputPath = path.join(__dirname, 'cursor-agents-instructions.md');
fs.writeFileSync(outputPath, CURSOR_AGENTS_INSTRUCTIONS);

console.log(`\n✅ Instructions saved to: ${outputPath}`);
console.log('\n🎯 Next Steps:');
console.log('1. Copy the AI prompt template to Cursor Agents');
console.log('2. Start with priority components (EditableField, SimpleCommentSystem, StarRating)');
console.log('3. Report progress and sync changes regularly');
console.log('4. Focus on one component at a time for quality');

module.exports = {
  CURSOR_AGENTS_INSTRUCTIONS,
  getInstructions: () => CURSOR_AGENTS_INSTRUCTIONS
}; 