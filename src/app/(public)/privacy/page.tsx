...
export async function generateMetadata() {
  ...
  const privacyData = cmsData?.pages?.privacy;
      ...
      <Container maxWidth="full" padding="xl" variant="section">
        <Stack spacing="xl" align="center">
          <Stack spacing="md" align="center">
            ...
            >
              {getCMSField(cmsData, 'pages.privacy.effectiveDate', 'Effective Date: January 2025')}
            </Text>
          </Stack>
        </Stack>
      </Container>
        ...
        <Stack spacing="lg">
          <Stack data-testid="privacy-sections-list" spacing="lg">
            <Box data-testid="privacy-section-0">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-0" data-cms-id="pages.privacy.sections.0.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.0.title', '1. Information We Collect')}
                </H4>
                <Text data-testid="privacy-section-content-0" data-cms-id="pages.privacy.sections.0.content">
                ...
                <Stack data-testid="privacy-section-items-0" spacing="sm">
                  <Text data-testid="privacy-section-item-0-0" data-cms-id="pages.privacy.sections.0.items.0">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.0.items.0', 'Name and contact information (phone, email, address)')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-0-1" data-cms-id="pages.privacy.sections.0.items.1">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.0.items.1', 'Pickup and destination locations')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-0-2" data-cms-id="pages.privacy.sections.0.items.2">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.0.items.2', 'Travel dates and times')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-0-3" data-cms-id="pages.privacy.sections.0.items.3">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.0.items.3', 'Flight information (when applicable)')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-0-4" data-cms-id="pages.privacy.sections.0.items.4">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.0.items.4', 'Payment information')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-0-5" data-cms-id="pages.privacy.sections.0.items.5">
            ...
            <Box data-testid="privacy-section-1">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-1" data-cms-id="pages.privacy.sections.1.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.1.title', '2. How We Use Information')}
                </H4>
                <Text data-testid="privacy-section-content-1" data-cms-id="pages.privacy.sections.1.content">
                ...
                <Stack data-testid="privacy-section-items-1" spacing="sm">
                  <Text data-testid="privacy-section-item-1-0" data-cms-id="pages.privacy.sections.1.items.0">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.1.items.0', 'Provide and coordinate transportation services')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-1-1" data-cms-id="pages.privacy.sections.1.items.1">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.1.items.1', 'Process payments and send confirmations')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-1-2" data-cms-id="pages.privacy.sections.1.items.2">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.1.items.2', 'Communicate with you about your bookings')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-1-3" data-cms-id="pages.privacy.sections.1.items.3">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.1.items.3', 'Send service updates and notifications')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-1-4" data-cms-id="pages.privacy.sections.1.items.4">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.1.items.4', 'Improve our services and customer experience')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-1-5" data-cms-id="pages.privacy.sections.1.items.5">
            ...
            <Box data-testid="privacy-section-2">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-2" data-cms-id="pages.privacy.sections.2.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.2.title', '3. Information Sharing')}
                </H4>
                <Text data-testid="privacy-section-content-2" data-cms-id="pages.privacy.sections.2.content">
                ...
                <Stack data-testid="privacy-section-items-2" spacing="sm">
                  <Text data-testid="privacy-section-item-2-0" data-cms-id="pages.privacy.sections.2.items.0">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.2.items.0', 'With our driver to coordinate your transportation')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-2-1" data-cms-id="pages.privacy.sections.2.items.1">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.2.items.1', 'With payment processors to handle transactions')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-2-2" data-cms-id="pages.privacy.sections.2.items.2">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.2.items.2', 'When required by law or legal process')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-2-3" data-cms-id="pages.privacy.sections.2.items.3">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.2.items.3', 'To protect our rights, property, or safety')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-2-4" data-cms-id="pages.privacy.sections.2.items.4">
            ...
            <Box data-testid="privacy-section-3">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-3" data-cms-id="pages.privacy.sections.3.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.3.title', '4. Data Security')}
                </H4>
                <Text data-testid="privacy-section-content-3" data-cms-id="pages.privacy.sections.3.content">
                ...
                <Stack data-testid="privacy-section-items-3" spacing="sm">
                  <Text data-testid="privacy-section-item-3-0" data-cms-id="pages.privacy.sections.3.items.0">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.3.items.0', 'Encrypted data transmission')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-3-1" data-cms-id="pages.privacy.sections.3.items.1">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.3.items.1', 'Secure payment processing')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-3-2" data-cms-id="pages.privacy.sections.3.items.2">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.3.items.2', 'Limited access to personal information')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-3-3" data-cms-id="pages.privacy.sections.3.items.3">
            ...
            <Box data-testid="privacy-section-4">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-4" data-cms-id="pages.privacy.sections.4.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.4.title', '5. Data Retention')}
                </H4>
                <Text data-testid="privacy-section-content-4" data-cms-id="pages.privacy.sections.4.content">
            ...
            <Box data-testid="privacy-section-5">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-5" data-cms-id="pages.privacy.sections.5.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.5.title', '6. Your Rights')}
                </H4>
                <Text data-testid="privacy-section-content-5" data-cms-id="pages.privacy.sections.5.content">
                ...
                <Stack data-testid="privacy-section-items-5" spacing="sm">
                  <Text data-testid="privacy-section-item-5-0" data-cms-id="pages.privacy.sections.5.items.0">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.5.items.0', 'Access and review your personal information')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-5-1" data-cms-id="pages.privacy.sections.5.items.1">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.5.items.1', 'Request corrections to inaccurate information')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-5-2" data-cms-id="pages.privacy.sections.5.items.2">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.5.items.2', 'Request deletion of your information (subject to legal requirements)')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-5-3" data-cms-id="pages.privacy.sections.5.items.3">
                    {`• ${getCMSField(cmsData, 'pages.privacy.sections.5.items.3', 'Opt out of marketing communications')}`}
                  </Text>
                  <Text data-testid="privacy-section-item-5-4" data-cms-id="pages.privacy.sections.5.items.4">
            ...
            <Box data-testid="privacy-section-6">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-6" data-cms-id="pages.privacy.sections.6.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.6.title', '7. Cookies and Tracking')}
                </H4>
                <Text data-testid="privacy-section-content-6" data-cms-id="pages.privacy.sections.6.content">
            ...
            <Box data-testid="privacy-section-7">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-7" data-cms-id="pages.privacy.sections.7.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.7.title', '8. Third-Party Links')}
                </H4>
                <Text data-testid="privacy-section-content-7" data-cms-id="pages.privacy.sections.7.content">
            ...
            <Box data-testid="privacy-section-8">
              <Stack spacing="md">
                <H4 data-testid="privacy-section-title-8" data-cms-id="pages.privacy.sections.8.title">
                  {getCMSField(cmsData, 'pages.privacy.sections.8.title', '9. Contact Us')}
                </H4>
                <Text data-testid="privacy-section-content-8" data-cms-id="pages.privacy.sections.8.content">
