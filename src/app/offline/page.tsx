        ...
        <Stack spacing="lg" align="center">
          ...
          <Stack spacing="md" align="center">
            ...
            <Stack spacing="sm" align="flex-start">
              <Text size="sm">{pageCmsData?.['offline-feature-1'] || '• Book airport transportation'}</Text>
              <Text size="sm">{pageCmsData?.['offline-feature-2'] || '• View your existing bookings'}</Text>
              <Text size="sm">{pageCmsData?.['offline-feature-3'] || '• Track your driver in real-time'}</Text>
              <Text size="sm">{pageCmsData?.['offline-feature-4'] || '• Get notifications about your ride'}</Text>
            </Stack>
          </Stack>
