...
function BookingStatusPageContent({ cmsData, bookingId }: StatusClientProps) {
...
export default function StatusClient({ cmsData, bookingId }: StatusClientProps) {
  return (
    <ToastProvider>
      <BookingStatusPageContent cmsData={cmsData} bookingId={bookingId} />
    </ToastProvider>
  );
}
