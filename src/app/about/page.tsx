...
import { EditableTitle } from '@/components/admin/EditableField';
    ...
    <PageContainer>
      ...
      <PageContent>
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-6 text-gray-900">Our Commitment</h2>
          ...
          {/* Our Fleet Section */}
          <section>
            <h2 className="text-2xl font-semibold mb-6 text-gray-900">Our Fleet</h2>
            <p className="text-lg text-gray-700 mb-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-6 text-gray-900">Service Areas</h2>
            <p className="text-lg text-gray-700 mb-6">
