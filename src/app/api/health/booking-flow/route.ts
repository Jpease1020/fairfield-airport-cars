...
export async function GET() {
  ...
  try {
    ...
    const envVars = {
      ...
      CHAT_BOOKING_PROD_ENABLED: !!process.env.CHAT_BOOKING_PROD_ENABLED,
      ...
      NEXT_PUBLIC_CHAT_BOOKING_PROD_ENABLED: !!process.env.NEXT_PUBLIC_CHAT_BOOKING_PROD_ENABLED,
