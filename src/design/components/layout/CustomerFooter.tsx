...
import { Container, Stack, Text, Span } from '@/ui';
  ...
  return (
    <Container maxWidth="xl">
      <Stack spacing="lg" align="center">
        {/* Main Footer Content */}
        <Stack direction="horizontal" spacing="lg" align="center" justify="between" fullWidth>
          {/* Company Info */}
          <Stack spacing="sm">
            <Text variant="lead">
        ...
        {/* Bottom Bar */}
        <Stack direction="horizontal" spacing="md" align="center" justify="between" fullWidth>
          <Text size="sm" color="secondary">
