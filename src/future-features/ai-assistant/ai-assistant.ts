...
export const callOpenAI = async (message: string, context: AIAssistantContext) => {
  ...
  const systemPrompt = `You are an AI assistant for ${context.businessInfo.name || 'Fairfield Airport Cars'} in ${context.businessInfo.address || 'Fairfield, CT'}. You help manage bookings, customers, and business operations. You also have knowledge about the technical aspects of the app.
