...
import { Button, Badge, Text, Span, Container, EditableText, Textarea, Select } from '@/ui';
      ...
      {isOpen && (
        <Container variant="card" padding="lg">
          ...
          <Container spacing="md">
              ...
              <Select 
                value={category} 
                onValueChange={(value: string) => setCategory(value as PageComment['category'])}
                options={[
              ...
              <Select 
                value={priority} 
                onValueChange={(value: string) => setPriority(value as PageComment['priority'])}
                options={[
                  { value: 'low', label: 'Low' },
